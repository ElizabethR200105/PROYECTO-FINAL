...
*/
    ...
    int main()
    {
        ...
        Tienda tienda("Autos Premier", "Av. Tomas Valle, Independencia", "969365258");

        Empleado empleado1(202401, 5, "Brandon jhoel", "Mendoza Vega");
        Empleado empleado2(202402, 4, "Elizabeth Beatriz", "Requena Alania");
        Empleado empleado3(202403, 7, "Juber Richard", "Zegarra Martel");
        Empleado empleado4(202404, 6, "Rayser Branco", "Rubina Rengifo");
        ...
        Autos vendidos4[empleado4.getCantidadVendidos()] = {auto_19, auto_18, auto_07, auto_05, auto_10, auto_02};

        Empleado empleados[4] = {empleado1, empleado2, empleado3, empleado4};
        ...
        if (accion == 2)
        {
            ...
            cin >> codigo;
            while (codigo != empleado1.getCodigo() && codigo != empleado2.getCodigo() && codigo != empleado3.getCodigo() && codigo != empleado4.getCodigo())
            {
                system("cls");
